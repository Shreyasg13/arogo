...
TRASHABLE = [
    ...
    Trashable('blood_donations', 'Blood donation',
              ...
              'donations'),
    Trashable('falls', 'Fall',
              lambda r: _dated(_d(r, 'place') or 'Fall', r, 'fell_on'),
              'falls'),
    Trashable('hearing_records', 'Hearing record',
              lambda r: _dated(_d(r, 'device') or _d(r, 'provider') or 'Hearing',
                               r, 'record_date'),
              'hearing'),
    Trashable('rehab_plans', 'Rehab plan', lambda r: _d(r, 'name'), 'rehab'),
    Trashable('rehab_logs', 'Rehab session',
              lambda r: _dated('Session', r, 'date_key'), 'rehab'),
