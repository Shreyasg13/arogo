...
const I18N = {
  hi: {
    ...
    'Send SOS': 'SOS भेजें',
    '🩺 Log Symptoms': '🩺 लक्षण दर्ज करें', 'Tap to select multiple': 'एक से ज़्यादा चुनने के लिए टैप करें',
    '🤕 Headache': '🤕 सिरदर्द', '😴 Fatigue': '😴 थकान', '🤢 Nausea': '🤢 मिचली',
    '🦴 Back Pain': '🦴 पीठ दर्द', '💔 Chest Pain': '💔 सीने में दर्द', '💫 Dizziness': '💫 चक्कर',
    '😮‍💨 Breathless': '😮‍💨 साँस फूलना', '🌡️ Fever': '🌡️ बुखार', '🦵 Joint Pain': '🦵 जोड़ों का दर्द',
    '😰 Anxiety': '😰 घबराहट', '🫁 Cough': '🫁 खांसी', '🫃 Bloating': '🫃 पेट फूलना',
    '🌙 Insomnia': '🌙 अनिद्रा', '💪 Cramps': '💪 ऐंठन', '👁️ Eye Strain': '👁️ आँखों का तनाव',
    '⚡ Migraine': '⚡ माइग्रेन',
    'Type a custom symptom and press Enter…': 'अपना लक्षण लिखें और एंटर दबाएँ…',
    '✓ Selected:': '✓ चुने गए:', 'Severity (1–10)': 'गंभीरता (1–10)', 'Time of day': 'दिन का समय',
    '☀️ Morning': '☀️ सुबह', '🌤️ Afternoon': '🌤️ दोपहर', '🌆 Evening': '🌆 शाम',
    '🌙 Night': '🌙 रात', '🔄 All day': '🔄 पूरे दिन', '(optional)': '(वैकल्पिक)',
    'Any extra context…': 'कोई अतिरिक्त जानकारी…', 'Select at least one symptom above': 'ऊपर कम से कम एक लक्षण चुनें',
    'Log Symptoms': 'लक्षण दर्ज करें', 'Symptom History': 'लक्षण इतिहास', 'Last 14 days': 'पिछले 14 दिन',
    'Log Reading': 'रीडिंग दर्ज करें', '❤️ Blood Pressure': '❤️ रक्तचाप', '🩸 Blood Sugar': '🩸 रक्त शर्करा',
    '💓 Heart Rate': '💓 हृदय गति', '🌡️ Temperature': '🌡️ तापमान', '💨 SpO2': '💨 SpO2',
    'e.g. Before breakfast, after walk…': 'जैसे नाश्ते से पहले, सैर के बाद…', 'Save Reading': 'रीडिंग सहेजें',
    '30-Day History': '30-दिन इतिहास', '⏰ Reminders to take a reading': '⏰ रीडिंग लेने की याद',
    ...
    'Health ID': 'हेल्थ ID',
    'A card to show at a hospital or pharmacy — print it or keep it on your phone': 'अस्पताल या फार्मेसी में दिखाने के लिए एक कार्ड — इसे प्रिंट करें या फ़ोन में रखें',
    '%1 yrs': '%1 वर्ष', 'female': 'महिला', 'male': 'पुरुष', 'other': 'अन्य',
    'Blood type': 'रक्त समूह', 'Allergies': 'एलर्जी', 'Conditions': 'स्थितियाँ',
    'Current medicines': 'वर्तमान दवाइयाँ', 'In an emergency, call': 'आपात स्थिति में कॉल करें',
    'Contact': 'संपर्क', 'Insurance': 'बीमा',
    'Add your name in Settings': 'सेटिंग्स में अपना नाम जोड़ें',
    'Generated by Arogo from your own records. Not a substitute for official ID.': 'आपके अपने रिकॉर्ड से Arogo द्वारा बनाया गया। आधिकारिक पहचान-पत्र का विकल्प नहीं।',
    'Print / Save PDF': 'प्रिंट / PDF सहेजें', 'Edit details': 'विवरण संपादित करें',
    'Fill in your blood type, allergies and an emergency contact under Edit details to make this card useful.': 'इस कार्ड को उपयोगी बनाने के लिए विवरण संपादित करें में अपना रक्त समूह, एलर्जी और एक आपातकालीन संपर्क भरें।',
    '%1, here’s your %2': '%1, यह रहा आपका %2', 'week': 'सप्ताह', 'month': 'महीना',
    'doses taken': 'खुराक ली', 'avg sleep': 'औसत नींद', 'ml water/day': 'मि.ली. पानी/दिन',
    'Vitals': 'वाइटल्स', 'rising': 'बढ़ रहा', 'falling': 'घट रहा', 'steady': 'स्थिर', 'need more readings': 'और रीडिंग चाहिए',
    'no reading yet': 'अभी कोई रीडिंग नहीं', 'ml water/day ': 'मि.ली. पानी/दिन',
    'Log meds, vitals or a goal to see your recap here.': 'यहाँ अपना सारांश देखने के लिए दवाइयाँ, वाइटल्स या लक्ष्य दर्ज करें।',
    'Patterns worth noticing': 'ध्यान देने योग्य पैटर्न',
    'These are patterns in your own logs, not proven causes.': 'ये आपके अपने लॉग में पैटर्न हैं, सिद्ध कारण नहीं।',
    'On days you logged <b>%1</b>, you’d slept about <b>%2 h</b> — vs %3 h on other days.': '<b>%1</b> दर्ज करने वाले दिनों में आप लगभग <b>%2 घं</b> सोए — बनाम अन्य दिनों में %3 घं।',
    '<b>%1</b> first appeared %2 after you started <b>%3</b> — worth mentioning to your doctor.': 'आपके <b>%3</b> शुरू करने के %2 बाद <b>%1</b> पहली बार दिखा — डॉक्टर को बताने लायक।',
    'the same day': 'उसी दिन', '%1 days': '%1 दिन',
    '<b>%1</b> mostly showed up %2 (%3 of %4 times).': '<b>%1</b> ज़्यादातर %2 दिखा (%4 में से %3 बार)।',
    'during your period': 'आपके मासिक धर्म के दौरान', 'in the days before your period': 'आपके मासिक धर्म से पहले के दिनों में',
    'Medication reminders': 'दवा अनुस्मारक',
    "How long 'snooze' waits, and how early each medicine reminds you": 'स्नूज़ कितनी देर रुके, और हर दवा कितनी जल्दी याद दिलाए',
    'Snooze for': 'स्नूज़ करें', 'Used when you tap Snooze on a dose reminder.': 'जब आप खुराक अनुस्मारक पर स्नूज़ दबाते हैं तब उपयोग होता है।',
    ...
    'Scan for emergency info': 'आपातकालीन जानकारी हेतु स्कैन करें',
    ...
    'Who is responsible': 'कौन ज़िम्मेदार है', 'Review date (optional)': 'समीक्षा तिथि (वैकल्पिक)',
    'No plan yet': 'अभी कोई योजना नहीं',
    'Add what you and your care team have agreed on — medicines, lifestyle changes, things to monitor, appointments.': 'आपने और आपकी देखभाल टीम ने जो तय किया है उसे जोड़ें — दवाइयाँ, जीवनशैली में बदलाव, निगरानी की चीज़ें, अपॉइंटमेंट।',
    '%1 active · %2 done': '%1 सक्रिय · %2 पूर्ण',
    'Medication': 'दवा', 'Lifestyle': 'जीवनशैली', 'Monitoring': 'निगरानी', 'Appointments': 'अपॉइंटमेंट', 'Other': 'अन्य',
    'Me': 'मैं', 'Caregiver': 'देखभालकर्ता', 'Doctor': 'डॉक्टर',
    'Mark done': 'पूर्ण चिह्नित करें', 'Mark active': 'सक्रिय चिह्नित करें',
    'review %1': 'समीक्षा %1', 'Added to plan': 'योजना में जोड़ा गया', 'Enter what to do': 'क्या करना है दर्ज करें',
    ...
    'other': 'अन्य',
    // Weekly report
    'Analysing your last 7 days…': 'आपके पिछले 7 दिनों का विश्लेषण…',
    'Could not load report data.': 'रिपोर्ट डेटा लोड नहीं हो सका।',
    ...
    '⭐ Habits': '⭐ आदतें',
    '🩺 Symptoms': '🩺 लक्षण',
    '⚖️ Body & Vitals': '⚖️ शरीर व वाइटल्स',
    'h avg': 'घं औसत',
    'active days': 'सक्रिय दिन',
    'adherence': 'पालन',
    'completion': 'पूर्णता',
    'unique': 'अद्वितीय',
    '%1 nights logged': '%1 रातें दर्ज',
    '%1 workouts completed': '%1 कसरतें पूरी',
    '%1 kcal consumed': '%1 kcal खाया',
    '%1 habits tracked': '%1 आदतें ट्रैक',
    'this week': 'इस हफ़्ते',
    'No body metrics logged': 'कोई शरीर माप दर्ज नहीं',
    'Quality': 'गुणवत्ता',
    'Common guideline': 'सामान्य दिशानिर्देश',
    'Calories burned': 'कैलोरी जली',
    'Weekly target': 'साप्ताहिक लक्ष्य',
    'Daily target': 'दैनिक लक्ष्य',
    'Avg hydration': 'औसत हाइड्रेशन',
    'Done': 'पूर्ण',
    'Status': 'स्थिति',
    'Blood Pressure': 'रक्तचाप',
    'Blood Sugar': 'रक्त शर्करा',
    'Heart Rate': 'हृदय गति',
    '7–9h / night': '7–9घं / रात',
    '150 min / week': '150 मिनट / सप्ताह',
    'Not set': 'सेट नहीं',
    '✅ Great': '✅ बढ़िया',
    '⚠️ Keep going': '⚠️ जारी रखें',
    'No symptoms logged ✅': 'कोई लक्षण दर्ज नहीं ✅',
    'No vitals recorded': 'कोई वाइटल दर्ज नहीं',
    'For your doctor:': 'आपके डॉक्टर के लिए:',
    'This is a personal health summary generated by Arogo. Data is self-reported and should be reviewed alongside clinical assessments.': 'यह Arogo द्वारा तैयार एक व्यक्तिगत स्वास्थ्य सारांश है। डेटा स्वयं-रिपोर्ट किया गया है और इसे नैदानिक मूल्यांकन के साथ देखा जाना चाहिए।',
    // Family explainer + activity/gym modal
    'How sharing works': 'साझाकरण कैसे काम करता है',
    'Nothing is shared by default.': 'डिफ़ॉल्ट रूप से कुछ साझा नहीं होता।',
    'Each category is off until you turn it on — and you can switch any of them off again anytime.': 'हर श्रेणी तब तक बंद रहती है जब तक आप उसे चालू न करें — और आप उसे कभी भी फिर बंद कर सकते हैं।',
    'You choose per category.': 'आप हर श्रेणी अलग से चुनते हैं।',
    'Sharing medicines doesn\'t share your journal; sharing sleep doesn\'t share your vitals.': 'दवाइयाँ साझा करने से आपकी डायरी साझा नहीं होती; नींद साझा करने से आपके वाइटल्स साझा नहीं होते।',
    'Missed-dose alerts are opt-in.': 'खुराक-चूक अलर्ट वैकल्पिक हैं।',
    'Your family is only told about a missed dose if you turn that on — and you always get a heads-up first.': 'आपके परिवार को खुराक चूकने की जानकारी तभी मिलती है जब आप इसे चालू करें — और आपको हमेशा पहले सूचना मिलती है।',
    'Primary vs. viewer.': 'प्राथमिक बनाम दर्शक।',
    'Anyone can see what\'s shared; only those who opt in to "Notify me…" get pinged about missed doses.': 'जो साझा है उसे कोई भी देख सकता है; केवल जिन्होंने "मुझे सूचित करें…" चुना है उन्हें खुराक चूकने की सूचना मिलती है।',
    'Distance & Pace': 'दूरी व गति',
    'Performance': 'प्रदर्शन',
    'Steps & Elevation': 'कदम व ऊँचाई',
    'Duration': 'अवधि',
    'Match Details': 'मैच विवरण',
    'Swim Details': 'तैराकी विवरण',
    'Outdoor Details': 'बाहरी विवरण',
    'Golf Details': 'गोल्फ विवरण',
    'Ride Details': 'सवारी विवरण',
    'Session Details': 'सत्र विवरण',
    'Duration (min)': 'अवधि (मिनट)',
    'Distance (km)': 'दूरी (किमी)',
    'Distance walked (km)': 'चली गई दूरी (किमी)',
    'Calories': 'कैलोरी',
    'Calories (est)': 'कैलोरी (अनुमानित)',
    'Avg Heart Rate': 'औसत हृदय गति',
    'Steps': 'कदम',
    'Elevation (m)': 'ऊँचाई (मी)',
    '🫀 Cardio': '🫀 कार्डियो',
    '⚡ HIIT': '⚡ HIIT',
    '💪 Upper Body': '💪 ऊपरी शरीर',
    '🦵 Lower Body': '🦵 निचला शरीर',
    '🏋️ Full Body': '🏋️ पूरा शरीर',
    '🔥 Core': '🔥 कोर',
    '🧘 Flexibility': '🧘 लचीलापन',
    'Rounds': 'राउंड',
    'Select at least one workout type above': 'ऊपर कम से कम एक कसरत प्रकार चुनें',
    'Overall Session': 'समग्र सत्र',
    'Total Duration (min)': 'कुल अवधि (मिनट)',
    'Total Calories (est)': 'कुल कैलोरी (अनुमानित)',
    'Max Heart Rate': 'अधिकतम हृदय गति',
    'Workout Type': 'कसरत प्रकार',
    ' — select all that apply': ' — सभी लागू चुनें',
    'Exercise': 'व्यायाम',
    'Sets': 'सेट',
    'Reps': 'दोहराव',
    'Weight': 'वज़न',
...
function familyExplainer() {
  return `
      <details class="family-explainer">
        <summary>${t('How sharing works')}</summary>
        <ul>
          <li><b>${t('Nothing is shared by default.')}</b> ${t('Each category is off until you turn it on — and you can switch any of them off again anytime.')}</li>
          <li><b>${t('You choose per category.')}</b> ${t("Sharing medicines doesn't share your journal; sharing sleep doesn't share your vitals.")}</li>
          <li><b>${t('Missed-dose alerts are opt-in.')}</b> ${t('Your family is only told about a missed dose if you turn that on — and you always get a heads-up first.')}</li>
          <li><b>${t('Primary vs. viewer.')}</b> ${t('Anyone can see what\'s shared; only those who opt in to "Notify me…" get pinged about missed doses.')}</li>
        </ul>
      </details>`;
}
...
// rendered when there's a visit AND something actually changed since it.
function _renderVisitPrep(vp, esc, fmt) {
  if (!vp || !vp.last_visit) return '';
  const lbl = t => String(t || '').replace(/_/g, ' ');
  const vitals = (vp.vitals_changes || []).map(v => {
    const from = `${v.from.value1}${v.from.value2 ? '/' + v.from.value2 : ''}`;
    const to = `${v.to.value1}${v.to.value2 ? '/' + v.to.value2 : ''}`;
    return `<tr><td>${esc(lbl(v.type))}</td><td>${esc(from)} → <b>${esc(to)}</b> ${esc(v.unit || '')}</td><td>${fmt(v.to.date)}</td></tr>`;
  }).join('');
  const labs = (vp.new_labs || []).map(l =>
    `<li>${esc(l.name || '')}: ${esc(String(l.value))} ${esc(l.unit || '')} <span class="ds-muted">(${fmt(l.date)})</span></li>`).join('');
  const medWord = { started: 'started', stopped: 'stopped', deleted: 'removed' };
  const meds = (vp.med_changes || []).map(m =>
    `<li>${esc(medWord[m.kind] || m.kind)}: ${esc(m.name || '')} <span class="ds-muted">(${fmt(m.date)})</span></li>`).join('');
  if (!vitals && !labs && !meds) return '';
  return `<h2 class="ds-h2">Since your last visit (${fmt(vp.last_visit.date)})</h2>
    ${vitals ? `<table class="ds-table"><thead><tr><th>Vital</th><th>Change</th><th>Latest</th></tr></thead><tbody>${vitals}</tbody></table>` : ''}
    ${labs ? `<div class="ds-muted" style="margin-top:6px"><b>New labs:</b></div><ul class="ds-list">${labs}</ul>` : ''}
    ${meds ? `<div class="ds-muted" style="margin-top:6px"><b>Medication changes:</b></div><ul class="ds-list">${meds}</ul>` : ''}`;
}
...
function renderDoctorSummary(d) {
  ...
  return `
    <div class="ds-sheet">
      ...
      ${_renderVisitPrep(d.visit_prep, esc, fmt)}
      ${(d.questions || []).length ? `<h2 class="ds-h2">Questions to ask</h2><ul class="ds-list">${d.questions.map(q => `<li>${esc(q)}</li>`).join('')}</ul>` : ''}
  ...
  groups.forEach(groupKey => {
    ...
    html += `<div class="act-field-section">
      <div class="act-field-divider">
        <div class="act-field-divider-label">${t(schema.label)}</div>
...
function renderGymFields(container) {
  ...
  if (ordered.length === 0) {
    sectionsHtml = `<div class="gym-empty-hint">${t('Select at least one workout type above')}</div>`;
  }
  ...
  const sharedHtml = showShared ? `
    <div class="act-field-divider" style="margin-top:4px">
      <div class="act-field-divider-label">${t('Overall Session')}</div>
      <div class="act-field-divider-line"></div>
    </div>
    <div class="form-row" style="margin-bottom:12px">
      <div class="form-group">
        <label class="form-label">${t('Total Duration (min)')}</label>
        <input type="number" class="form-input" name="duration" placeholder="60">
      </div>
      <div class="form-group">
        <label class="form-label">${t('Total Calories (est)')}</label>
        <input type="number" class="form-input" name="calories" placeholder="400">
      </div>
    </div>
    <div class="form-row" style="margin-bottom:12px">
      <div class="form-group">
        <label class="form-label">${t('Avg Heart Rate')}</label>
        <input type="number" class="form-input" name="heart_rate_avg" placeholder="130">
      </div>
      <div class="form-group">
        <label class="form-label">${t('Max Heart Rate')}</label>
  ...
  container.innerHTML = `
    <div class="act-field-section">
      <div class="act-field-divider">
        <div class="act-field-divider-label">${t('Workout Type')} <span style="font-size:9px;color:var(--gray-400);text-transform:none;letter-spacing:0;font-weight:400">${t(' — select all that apply')}</span></div>
        <div class="act-field-divider-line"></div>
      </div>
...
function renderSetsTable(subId) {
  ...
  return `<div style="margin-bottom:12px;overflow-x:auto">
    <table class="sets-table">
      <thead><tr>
        <th style="width:42%">${t('Exercise')}</th>
        <th>${t('Sets')}</th><th>${t('Reps')}</th><th>${t('Weight')}</th><th></th>
      </tr></thead>
      <tbody>${rows}</tbody>
    </table>
    <button type="button" class="sets-add-btn" data-ev-click="addGymSet('${subId}')">${t('+ Add exercise')}</button>
  </div>`;
}
...
async function loadDoctorQuestions() {
  ...
  if (!el) return;
  const d = await fetch('/api/doctor-questions').then(r => r.json()).catch(() => ({ questions: [] }));
  const qs = d.questions || [];
  if (!qs.length) {
    el.innerHTML = `<div style="font-size:13px;color:var(--gray-400);padding:6px 0">No questions yet — jot down anything you want to remember to ask.</div>`;
    return;
  }
  el.innerHTML = qs.map(q => `
    <label class="dq-row ${q.asked ? 'is-asked' : ''}">
      <input type="checkbox" class="dq-check" ${q.asked ? 'checked' : ''} data-ev-change="toggleDoctorQuestion('${q.id}')">
      <span class="dq-text">${escHtml(q.question)}</span>
      <button class="dq-del" data-ev-click="delDoctorQuestion('${q.id}')" title="Remove">
        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
      </button>
    </label>`).join('');
}

async function addDoctorQuestion() {
  const inp = document.getElementById('dq-input');
  const q = (inp?.value || '').trim();
  if (!q) return;
  const r = await fetch('/api/doctor-questions', {
    method: 'POST', headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ question: q }),
  }).then(r => r.json()).catch(() => null);
  if (r?.success) { inp.value = ''; loadDoctorQuestions(); }
  else showToast('Could not add that question', 'error');
}

async function toggleDoctorQuestion(id) {
  await fetch(`/api/doctor-questions/${id}/toggle`, { method: 'POST' }).catch(() => {});
  loadDoctorQuestions();
}

async function delDoctorQuestion(id) {
  await fetch(`/api/doctor-questions/${id}`, { method: 'DELETE' }).catch(() => {});
  loadDoctorQuestions();
}
...
async function loadReport() {
  ...
  el.innerHTML = `<div class="report-generating">
    ...
    <div class="report-gen-text">${t('Analysing your last 7 days…')}</div>
  </div>`;

  const r = await fetch('/api/report/weekly').then(r=>r.json()).catch(()=>null);
  if (!r) { el.innerHTML = `<div style="padding:40px;color:var(--gray-400)">${t('Could not load report data.')}</div>`; return; }

  const Q_LABEL = {1:t('Very Poor'),2:t('Poor'),3:t('Fair'),4:t('Good'),5:t('Excellent')};
  const Q_EMOJI = {1:'😩',2:'😕',3:'😐',4:'😊',5:'😴'};
  const GOAL_LABELS = {lose_fast:t('Lose weight fast'),lose:t('Lose weight'),maintain:t('Maintain weight'),gain:t('Gain muscle'),gain_fast:t('Build mass')};
  ...
  el.innerHTML = `
  <!-- Health review recap (adherence / vitals direction / goals / wins) -->
  <div id="health-review-block"></div>
  ...
  <div id="printable-report" class="rpt-doc">
    ...
    <div class="rpt-header">
      <div class="rpt-header-left">
        <div class="rpt-patient-name">${escHtml(r.profile?.name||t('Health Report'))}</div>
        <div class="rpt-period">${t('Weekly Summary')} · ${periodStr}</div>
        <div class="rpt-generated">${tformat('Generated %1', generatedStr)}</div>
    ...
    <div class="rpt-grid">
      ...
      <div class="rpt-section">
        <div class="rpt-section-head">${t('🌙 Sleep')}</div>
        <div class="rpt-big">${r.sleep?.avg_hours ?? '—'}<span class="rpt-unit">${t('h avg')}</span></div>
        <div class="rpt-sub">${tformat('%1 nights logged', r.sleep?.nights||0)}</div>
        ${r.sleep?.avg_hours ? metricBar(r.sleep.avg_hours, 9, '#818CF8') : ''}
        <div class="rpt-detail-rows">
          ${r.sleep?.avg_quality ? `<div class="rpt-detail-row"><span>${t('Quality')}</span><span>${Q_EMOJI[Math.round(r.sleep.avg_quality)]} ${Q_LABEL[Math.round(r.sleep.avg_quality)]}</span></div>` : ''}
          ...
          <div class="rpt-detail-row"><span>${t('Common guideline')}</span><span>${t('7–9h / night')}</span></div>
        </div>
      </div>

      <!-- Fitness -->
      <div class="rpt-section">
        <div class="rpt-section-head">${t('🏃 Fitness')}</div>
        <div class="rpt-big">${r.fitness?.workout_days??0}<span class="rpt-unit">${t('active days')}</span></div>
        <div class="rpt-sub">${tformat('%1 workouts completed', r.fitness?.activities||0)}</div>
        ${metricBar(r.fitness?.workout_days||0, 7, '#34D399')}
        <div class="rpt-detail-rows">
          <div class="rpt-detail-row"><span>${t('Calories burned')}</span><span>${(r.fitness?.calories_burned||0).toLocaleString()} kcal</span></div>
          ...
          ${r.fitness?.activities ? `<div class="rpt-detail-row"><span>${t('Common guideline')}</span><span>${t('150 min / week')}</span></div>` : ''}
        </div>
      </div>

      <!-- Nutrition -->
      <div class="rpt-section">
        <div class="rpt-section-head">${t('🍽️ Nutrition')}</div>
        <div class="rpt-big">${r.nutrition?.adherence_pct != null ? Math.round(r.nutrition.adherence_pct)+'%' : '—'}<span class="rpt-unit">${t('adherence')}</span></div>
        <div class="rpt-sub">${tformat('%1 kcal consumed', (r.nutrition?.calories_eaten||0).toLocaleString())}</div>
        ...
        <div class="rpt-detail-rows">
          ...
          ${r.nutrition?.target ? `
          <div class="rpt-detail-row"><span>${t('Weekly target')}</span><span>${(r.nutrition.weekly_target||0).toLocaleString()} kcal</span></div>
          <div class="rpt-detail-row"><span>${t('Daily target')}</span><span>${r.nutrition.target.toLocaleString()} kcal/day</span></div>`
          : `<div class="rpt-detail-row"><span>${t('Daily target')}</span><span>${t('Not set')}</span></div>`}
          ${r.nutrition?.avg_hydration_ml ? `<div class="rpt-detail-row"><span>${t('Avg hydration')}</span><span>${r.nutrition.avg_hydration_ml} ml/day</span></div>` : ''}
        </div>
      </div>

      <!-- Habits -->
      <div class="rpt-section">
        <div class="rpt-section-head">${t('⭐ Habits')}</div>
        <div class="rpt-big">${r.habits?.completion_pct != null ? r.habits.completion_pct+'%' : '—'}<span class="rpt-unit">${t('completion')}</span></div>
        <div class="rpt-sub">${tformat('%1 habits tracked', r.habits?.total||0)}</div>
        ${r.habits?.completion_pct != null ? metricBar(r.habits.completion_pct, 100, '#A78BFA') : ''}
        <div class="rpt-detail-rows">
          <div class="rpt-detail-row"><span>${t('Done')}</span><span>${r.habits?.done_count||0} of ${(r.habits?.total||0)*7} check-ins</span></div>
          ${r.habits?.completion_pct != null ? `<div class="rpt-detail-row ${r.habits.completion_pct>=70?'rpt-row--good':'rpt-row--warn'}"><span>${t('Status')}</span><span>${r.habits.completion_pct>=70?t('✅ Great'):t('⚠️ Keep going')}</span></div>` : ''}
        </div>
      </div>

      <!-- Symptoms -->
      <div class="rpt-section">
        <div class="rpt-section-head">${t('🩺 Symptoms')}</div>
        <div class="rpt-big">${r.symptoms?.length??0}<span class="rpt-unit">${t('unique')}</span></div>
        <div class="rpt-sub">${t('this week')}</div>
        <div class="rpt-symptom-list">
          ${r.symptoms?.length ? r.symptoms.map(s => `
            ...
            </div>`).join('') : `<div style="color:var(--gray-400);font-size:13px;margin-top:8px">${t('No symptoms logged ✅')}</div>`}
        </div>
      </div>

      <!-- Body & Vitals -->
      <div class="rpt-section">
        <div class="rpt-section-head">${t('⚖️ Body & Vitals')}</div>
        ${r.body?.weight_kg ? `
    ...
    <div class="rpt-footer">
      <div class="rpt-footer-note">
        <strong>${t('For your doctor:')}</strong> ${t('This is a personal health summary generated by Arogo. Data is self-reported and should be reviewed alongside clinical assessments.')}
      </div>
  ...
  loadHealthReview(_reviewDays);
}

// ── Health review recap ────────────────────────────────────────────────────
// A 7- or 30-day snapshot the plain weekly summary leaves out: medication
// adherence, which way the vitals are heading, goal progress, and honest wins.
let _reviewDays = 7;

async function loadHealthReview(days) {
  _reviewDays = (days === 30) ? 30 : 7;
  const box = document.getElementById('health-review-block');
  if (!box) return;
  const rev = await fetch('/api/report/review?days=' + _reviewDays, {credentials:'same-origin'})
    .then(r => r.ok ? r.json() : null).catch(() => null);
  if (!rev) { box.innerHTML = ''; return; }
  box.innerHTML = renderHealthReview(rev);
}

function renderHealthReview(rev) {
  const DIR = { up: '↑', down: '↓', flat: '→' };
  const DIR_COLOR = { up: '#B4443A', down: '#4C9A5E', flat: 'var(--gray-400)' };
  const toggle = `<div class="hr-toggle">
      <button class="hr-tog${_reviewDays === 7 ? ' hr-tog--on' : ''}" data-ev-click="loadHealthReview(7)">${t('Last 7 days')}</button>
      <button class="hr-tog${_reviewDays === 30 ? ' hr-tog--on' : ''}" data-ev-click="loadHealthReview(30)">${t('Last 30 days')}</button>
    </div>`;

  // Wins
  const wins = (rev.wins || []).length ? `<div class="hr-wins">${
    rev.wins.map(w => `<div class="hr-win"><span>${w.icon}</span> ${escHtml(w.text)}</div>`).join('')}</div>` : '';

  // Adherence + sleep + hydration stat tiles
  const tiles = [];
  if (rev.adherence) tiles.push(`<div class="hr-tile"><div class="hr-tile-n">${rev.adherence.pct}%</div><div class="hr-tile-l">${t('doses taken')}</div></div>`);
  if (rev.sleep && rev.sleep.avg_hours != null) tiles.push(`<div class="hr-tile"><div class="hr-tile-n">${rev.sleep.avg_hours}h</div><div class="hr-tile-l">${t('avg sleep')}</div></div>`);
  if (rev.hydration_avg_ml) tiles.push(`<div class="hr-tile"><div class="hr-tile-n">${rev.hydration_avg_ml}</div><div class="hr-tile-l">${t('ml water/day')}</div></div>`);
  const tilesHTML = tiles.length ? `<div class="hr-tiles">${tiles.join('')}</div>` : '';

  // Vitals direction
  const vitals = (rev.vitals || []).map(v => {
    const arrow = v.direction ? `<span style="color:${DIR_COLOR[v.direction]};font-weight:700">${DIR[v.direction]}</span>` : '';
    const dirWord = v.direction ? t({up:'rising', down:'falling', flat:'steady'}[v.direction]) : t('need more readings');
    return `<div class="hr-vital">
        <div class="hr-vital-label">${t(v.label)}</div>
        <div class="hr-vital-val">${escHtml(v.latest)} <span class="hr-vital-unit">${v.unit}</span> ${arrow}</div>
        <div class="hr-vital-dir">${dirWord}</div>
      </div>`;
  }).join('');
  const vitalsHTML = vitals ? `<div class="hr-sub">${t('Vitals')}</div><div class="hr-vitals">${vitals}</div>` : '';

  // Goals
  const goals = (rev.goals || []).map(g => {
    const pct = g.progress != null ? Math.round(g.progress * 100) : null;
    const bar = pct != null
      ? `<div class="goal-bar" style="margin-top:5px"><div class="goal-fill${g.achieved ? ' goal-fill--done' : ''}" style="width:${pct}%"></div></div>`
      : `<div class="hr-goal-nodata">${t('no reading yet')}</div>`;
    const now = g.current != null ? `${g.current}${g.unit ? ' ' + g.unit : ''}` : '—';
  ...
  const empty = (!tiles.length && !vitals && !goals && !(rev.wins||[]).length)
    ? `<div class="hr-empty">${t('Log meds, vitals or a goal to see your recap here.')}</div>` : '';

  return `<div class="panel hr-panel">
      <div class="hr-head">
        <h2 class="hr-title">${tformat('%1, here’s your %2', escHtml(rev.name), _reviewDays === 30 ? t('month') : t('week'))}</h2>
        ${toggle}
      </div>
      ${wins}${tilesHTML}${vitalsHTML}${goalsHTML}${empty}
    </div>`;
}
...
async function loadReminderSettingsUI() {
  ...
  set('rs-default-snooze',  s.default_snooze_min || 10);
...
// Per-medicine reminder lead time, editable inside the reminders panel.
const _LEAD_OPTS = [0, 5, 10, 15, 30, 60];
async function renderMedLeads() {
  const box = document.getElementById('rs-med-leads');
  if (!box) return;
  const meds = await fetch('/api/medicines', {credentials:'same-origin'})
  ...
  box.innerHTML = `<div class="rs-lead-head">${t('Remind me ahead of each dose')}</div>${rows}`;
}

async function setMedLead(mid, minutes) {
  const r = await fetch(`/api/medicines/${mid}/reminder-lead`, {
    method:'POST', headers:{'Content-Type':'application/json'}, credentials:'same-origin',
    body: JSON.stringify({minutes: parseInt(minutes, 10)}),
  }).then(x => x.json()).catch(() => null);
  if (r?.success) showToast(t('Reminder timing updated'), 'success');
}
...
async function saveReminderSettings() {
  ...
  const settings = {
    ...
    default_snooze_min:      parseInt(get('rs-default-snooze') || 10, 10),
  };
...
// ── Health ID card ───────────────────────────────────────────────────────────
// A wallet-style card to show at a hospital/pharmacy. Composes the profile,
// the emergency card, and the user's ACTUAL active medicines (read live from
// the tracker, so it never drifts). Printable; contacts are tap-to-call.
async function loadHealthId() {
  const el = document.getElementById('health-id-content');
  if (!el) return;
  const d = await fetch('/api/health-id', {credentials:'same-origin'})
    .then(r => r.ok ? r.json() : null).catch(() => null);
  if (!d) { el.innerHTML = `<div class="panel" style="padding:20px">${t('Could not load')}</div>`; return; }
  el.innerHTML = renderHealthId(d);
  loadHealthIdQr();
}

// Scannable emergency QR on the ID card — a self-contained SVG from the server
// (segno). Renders only when there's info to encode and the library is present.
async function loadHealthIdQr() {
  const slot = document.getElementById('hid-qr');
  if (!slot) return;
  const d = await fetch('/api/health-id/qr').then(r => r.json()).catch(() => null);
  if (!d || !d.available || !d.svg) { slot.innerHTML = ''; return; }
  // The SVG is generated by our own backend (segno) — safe to inline.
  slot.innerHTML = `<div class="hid-qr-img">${d.svg}</div>
    <div class="hid-qr-cap">${t('Scan for emergency info')}</div>`;
}

function _hidRow(label, value, cls) {
  if (!value) return '';
  return `<div class="hid-row"><div class="hid-label">${t(label)}</div>
...
function renderHealthId(d) {
  ...
  let medsHtml = '';
  if ((d.active_medicines || []).length) {
    medsHtml = d.active_medicines.map(m =>
      `<li>${escHtml(m.name)}${m.dose ? ' · ' + escHtml(m.dose) : ''}</li>`).join('');
    medsHtml = `<ul class="hid-meds">${medsHtml}</ul>`;
  } else if (d.notes_medications) {
    medsHtml = `<div class="hid-value">${escHtml(d.notes_medications)}</div>`;
  }
  const medsBlock = medsHtml
    ? `<div class="hid-row"><div class="hid-label">${t('Current medicines')}</div>${medsHtml}</div>` : '';

  const contacts = (d.contacts || []).map(c => {
    const tel = (c.phone || '').replace(/[^\d+]/g, '');
    const num = c.phone ? `<a href="tel:${tel}" class="hid-tel">${escHtml(c.phone)}</a>` : '';
    return `<div class="hid-contact"><span>${escHtml(c.name || t('Contact'))}</span>${num}</div>`;
  }).join('');
  const contactsBlock = contacts
    ? `<div class="hid-row hid-emergency"><div class="hid-label">${t('In an emergency, call')}</div>
        <div class="hid-contacts">${contacts}</div></div>` : '';
  ...
  const card = `
    <div id="health-id-card" class="hid-card">
      <div class="hid-brand">🌱 Arogo · ${t('Health ID')}</div>
      <div class="hid-name">${escHtml(id.name || t('Add your name in Settings'))}</div>
  ...
  const actions = `<div class="hid-actions">
      <button class="btn-primary" data-ev-click="printHealthId()">🖨️ ${t('Print / Save PDF')}</button>
      <button class="btn-outline" data-ev-click="switchView('reports');setTimeout(()=>switchMedTab&&switchMedTab('emergency'),60)">${t('Edit details')}</button>
    </div>`;

  const empty = anyData ? '' :
    `<p class="hid-empty-note">${t('Fill in your blood type, allergies and an emergency contact under Edit details to make this card useful.')}</p>`;

  return card + actions + empty;
}

function printHealthId() {
  document.body.classList.add('printing-health-id');
  const clear = () => { document.body.classList.remove('printing-health-id'); window.removeEventListener('afterprint', clear); };
  window.addEventListener('afterprint', clear);
  try { window.print(); } catch (e) { clear(); }
  // Safari/some browsers don't fire afterprint reliably — clear on a fallback timer.
  setTimeout(clear, 1500);
}

// ── Shared care plan ─────────────────────────────────────────────────────────
// The agreements between a person, their caregiver and their doctor: what to do,
// who owns it, when to review. Shared through the same acting-as model, so a
// caregiver managing a member sees and edits that member's plan. All items are
// human-authored — the app never writes medical advice of its own.
const CARE_CAT = {
  medication:  {icon:'💊', label:'Medication'},
  lifestyle:   {icon:'🏃', label:'Lifestyle'},
  monitoring:  {icon:'📈', label:'Monitoring'},
  appointment: {icon:'📅', label:'Appointments'},
  other:       {icon:'📋', label:'Other'},
};
const CARE_OWNER = {me:'Me', caregiver:'Caregiver', doctor:'Doctor'};

async function loadCarePlan() {
  const el = document.getElementById('care-plan-content');
  if (!el) return;
  const d = await fetch('/api/care-plan', {credentials:'same-origin'})
    .then(r => r.ok ? r.json() : null).catch(() => null);
  if (!d) { el.innerHTML = `<div class="panel" style="padding:20px">${t('Could not load')}</div>`; return; }
  el.innerHTML = renderCarePlan(d);
}

function renderCarePlan(d) {
  const catOpts = (d.categories || []).map(c =>
    `<option value="${c}">${CARE_CAT[c] ? CARE_CAT[c].icon + ' ' + t(CARE_CAT[c].label) : c}</option>`).join('');
  const ownerOpts = (d.owners || []).map(o =>
    `<option value="${o}">${t(CARE_OWNER[o] || o)}</option>`).join('');
  ...
  const form = `<div class="panel" style="padding:18px 20px;margin-bottom:16px">
      ...
      <div class="cp-form">
        <input type="text" id="cp-title" class="form-input" placeholder="${t('What to do (e.g. Walk 30 min after dinner)')}" style="flex:2;min-width:200px">
        <select id="cp-category" class="form-input" style="max-width:160px">${catOpts}</select>
        <select id="cp-owner" class="form-input" style="max-width:130px" title="${t('Who is responsible')}">${ownerOpts}</select>
        <input type="date" id="cp-review" class="form-input" title="${t('Review date (optional)')}" style="max-width:150px">
        <button class="btn-primary" data-ev-click="addCareItem()">${t('Add')}</button>
      </div>
    </div>`;

  const s = d.summary || {};
  const summary = s.total ? `<div class="cp-summary">${
      tformat('%1 active · %2 done', s.active, s.done)}</div>` : '';

  if (!(d.items || []).length) {
    return form + `<div class="panel" style="padding:28px;text-align:center">
        <div style="font-size:30px;margin-bottom:8px">📋</div>
        <div style="font-size:14px;font-weight:600;margin-bottom:4px">${t('No plan yet')}</div>
        <div style="font-size:13px;color:var(--gray-400)">${t('Add what you and your care team have agreed on — medicines, lifestyle changes, things to monitor, appointments.')}</div>
      </div>`;
  }

  // Group by category, active before done (list already sorts done last).
  const byCat = {};
  d.items.forEach(i => { (byCat[i.category] = byCat[i.category] || []).push(i); });
  const groups = Object.keys(CARE_CAT).filter(c => byCat[c]).map(c => {
    const meta = CARE_CAT[c];
    const rows = byCat[c].map(i => {
      const done = i.status === 'done';
      const ownerChip = `<span class="cp-owner cp-owner--${i.owner}">${t(CARE_OWNER[i.owner] || i.owner)}</span>`;
      const review = i.review_date ? `<span class="cp-review">${tformat('review %1', i.review_date)}</span>` : '';
      return `<div class="cp-item${done ? ' cp-item--done' : ''}">
          <button class="cp-check${done ? ' cp-check--done' : ''}" title="${done ? t('Mark active') : t('Mark done')}"
                  data-ev-click="toggleCareItem('${i.id}','${done ? 'active' : 'done'}')">${done ? '✓' : ''}</button>
          <div class="cp-main">
            <div class="cp-item-title">${escHtml(i.title)}</div>
            ${i.detail ? `<div class="cp-item-detail">${escHtml(i.detail)}</div>` : ''}
            <div class="cp-item-meta">${ownerChip}${review}</div>
          </div>
          <button class="btn-icon" title="${t('Delete')}" data-ev-click="deleteCareItem('${i.id}')" style="color:var(--gray-300)">✕</button>
        </div>`;
    }).join('');
    return `<div class="panel cp-group" style="padding:14px 18px;margin-bottom:12px">
        <div class="cp-group-head">${meta.icon} ${t(meta.label)}</div>${rows}</div>`;
  }).join('');

  return form + summary + groups;
}

async function addCareItem() {
  const title = document.getElementById('cp-title')?.value?.trim();
  if (!title) { showToast(t('Enter what to do'), 'error'); return; }
  const body = {
    title,
    category: document.getElementById('cp-category')?.value || 'other',
    owner: document.getElementById('cp-owner')?.value || 'me',
    review_date: document.getElementById('cp-review')?.value || null,
  };
  const r = await fetch('/api/care-plan', {method:'POST', headers:{'Content-Type':'application/json'},
    credentials:'same-origin', body: JSON.stringify(body)}).then(x => x.json()).catch(() => null);
  if (r && r.success) { showToast(t('Added to plan')); loadCarePlan(); }
  else showToast((r && r.error) || t('Could not save'), 'error');
}

async function toggleCareItem(id, status) {
  await fetch('/api/care-plan/' + id, {method:'PATCH', headers:{'Content-Type':'application/json'},
    credentials:'same-origin', body: JSON.stringify({status})}).catch(() => {});
  loadCarePlan();
}
...
// Cross-factor correlations: honest "pattern, not proven cause" cards linking a
// symptom to short sleep, a medicine's start, or the menstrual cycle.
function renderSymptomCorrelations(corr) {
  if (!corr || !Array.isArray(corr.findings) || !corr.findings.length) return '';
  const card = (icon, text) =>
    `<div class="spp-corr-card"><span class="spp-corr-icon">${icon}</span><span>${text}</span></div>`;
  const cards = corr.findings.map(f => {
    if (f.type === 'sleep') {
      return card('😴', tformat('On days you logged <b>%1</b>, you’d slept about <b>%2 h</b> — vs %3 h on other days.',
        escHtml(f.symptom), f.symptom_avg, f.other_avg));
    }
    if (f.type === 'med_start') {
      return card('💊', tformat('<b>%1</b> first appeared %2 after you started <b>%3</b> — worth mentioning to your doctor.',
        escHtml(f.symptom), f.days_after === 0 ? t('the same day') : tformat('%1 days', f.days_after), escHtml(f.medicine)));
    }
    if (f.type === 'cycle') {
      const phase = f.phase === 'period' ? t('during your period') : t('in the days before your period');
      return card('🩸', tformat('<b>%1</b> mostly showed up %2 (%3 of %4 times).',
        escHtml(f.symptom), phase, f.count, f.total));
    }
    return '';
  }).join('');
  return `<div class="panel spp-corr" style="padding:16px 20px;margin-top:18px">
      <div class="panel-header" style="margin-bottom:6px">
        <h2 class="panel-title">${t('Patterns worth noticing')}</h2>
        <span class="panel-badge">${tformat('%1 days', corr.days)}</span>
      </div>
      <p class="spp-corr-note">${t('These are patterns in your own logs, not proven causes.')}</p>
      ${cards}
    </div>`;
}
...
async function loadSymptomPatterns() {
  ...
  const [data, corr] = await Promise.all([
    fetch('/api/symptoms/patterns?days=30', {cache:'no-store'}).then(r => r.json()).catch(() => null),
    fetch('/api/symptoms/correlations?days=60', {cache:'no-store'}).then(r => r.json()).catch(() => null),
  ]);
  ...
  // ── Cross-factor correlations (patterns, never causes) ────────
  const corrHTML = renderSymptomCorrelations(corr);
